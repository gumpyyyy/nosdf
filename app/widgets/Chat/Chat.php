...
class Chat extends WidgetBase {
    ...
    function onPresence($packet) {
        ...
        if(isset($contact) && $contact->chaton > 0 ) {
            ...
            RPC::call('lygneo_append', 'messages' . $contact->jid, $html);
    ...
    function onPresenceMucUser($packet) {
        ...
        RPC::call('lygneo_fill', 'list' . $presence->jid, $this->prepareMucList($presence->jid));
    }
    ...
    function onPresenceMuc($toggle) {
        ...
        RPC::call('lygneo_fill', 'chats', $this->prepareChats());
    ...
    function onMessage($message) {
        ...
        if($contact != null && $contact->chaton == 0) {
            ...
            RPC::call('lygneo_prepend', 'chats', $this->prepareChat($contact));
            RPC::call('scrollAllTalks');
        ...
        elseif($message->ressource != '') {
            ...
            RPC::call('lygneo_append', 'messages' . $message->jidfrom, $html);
    ...
    function onAttention($packet) {
        ...
        RPC::call('lygneo_append', 'messages' . $jid, $html);
    ...
    function ajaxCloseTalk($jid) {
        ...
        $contact->chaton = 0;
        $rd->setNow($contact);
        RPC::call('lygneo_delete', 'chat' . echapJid($jid));
        RPC::commit();
    }
