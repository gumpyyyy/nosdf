...
class Profile extends WidgetCommon
{
    ...
    function onMyVcardReceived($vcard = false)
    {
        ...
        RPC::call('lygneo_fill', 'profile', $html);
    }
    
    function onMyPresence()
    {
        RPC::call('lygneo_fill', 'statussaved', '✔ '.$this->__('status.saved')); 
            ...
            $html .= '
                <div class="textbubble">
                    <textarea 
                        ...
                        onload="lygneo_textarea_autoheight(this);"
                        onkeyup="lygneo_textarea_autoheight(this);">'.$presence['status'].'</textarea>
