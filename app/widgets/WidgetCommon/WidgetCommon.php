...
class WidgetCommon extends WidgetBase {
    ...
    protected function printPost($post, $comments = false, $public = false) {
        ...
        if(current(explode('.', $post->jid)) == 'nsfw')
            $spoiler = ' lygneo_toggle_class(this, \'show\')';
    ...
    protected function printMap($posts, $c = null) {
        ...
        if(isset($c) && $c->loclatitude != '' && $c->loclongitude != '') {    
            ...
            $javascript .= '
                var red = L.icon({
                    iconUrl: "'.BASE_URI.'/themes/lygneo/img/marker-icon.png",
    ...
    function ajaxShowPosition($pos)
    {
        ...
        RPC::call('lygneo_fill', 'postpublishlocation' , (string)$pos->display_name);
        RPC::commit();
    }
    ...
    function ajaxPostPreview($content)
    {
        if($content != '') {
            ...
            RPC::call('lygneo_fill', 'postpreviewcontent' , $content);
        } else
            RPC::call('lygneo_fill', 'postpreviewcontent' , __('post.empty'));
    ...
    function onComment($parent) {        
        ...
        RPC::call('lygneo_fill', $parent.'comments', $html);
    }
    ...
    function ajaxPrivacyPost($nodeid, $privacy) {
        ...
        RPC::call('lygneo_change_class', $nodeid , 'protect '.$privacy, getFlagTitle($privacy));
        RPC::commit();
    }
}
