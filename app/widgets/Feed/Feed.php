...
class Feed extends WidgetCommon {
    ...
    function onConfig(array $data)
    {
        ...
        RPC::call('lygneo_fill', 'feedhead', $this->prepareHead());
    }
    ...
    function onCommentPublishError() {
        ...
        RPC::call('lygneo_fill', 'feednotifs', $html);
    }
    ...
    function onPostPublished($post) {        
        ...
        RPC::call('lygneo_fill', 'feedcontent', $html);
        RPC::call('createTabs');
    }  
    ...
    function ajaxGetFeed($start) {
        ...
        RPC::call('lygneo_append', 'feedposts', $html);
        RPC::commit();
    }
