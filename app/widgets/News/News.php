...
class News extends WidgetCommon {
    ...
    function ajaxGetNews($start) {
        ...
        RPC::call('lygneo_append', 'newsposts', $html);
        RPC::commit();
    }
    ...
    function ajaxRefresh() {
        ...
        RPC::call('lygneo_fill', 'refresh', '');
        RPC::call('lygneo_fill', 'newsposts', $html);
        RPC::call('lygneo_posts_unread', 0);
    ...
    function onStream($payload) {
        ...
        if($count > 0) {
            ...
            RPC::call('lygneo_posts_unread', $count);
            RPC::call('lygneo_fill', 'refresh', $html);
