...
class Bookmark extends WidgetBase
{
    ...
    function prepareBookmark() {
        ...
        $urlview->assign(
            ...
            $this->genCallAjax(
                'ajaxBookmarkUrlAdd', 
                "lygneo_parse_form('bookmarkurladd')")
        );
        ...
        $mucview->assign(
            ...
            $this->genCallAjax(
                'ajaxBookmarkMucAdd', 
                "lygneo_parse_form('bookmarkmucadd')")
        );
    ...
    function onGroupSubscribed()
    {
        ...
        RPC::call('lygneo_fill', 'bookmarks', $html);   
    ...
    */
    ...
    function ajaxBookmarkMucAdd($form) 
    {
        if(!filter_var($form['jid'], FILTER_VALIDATE_EMAIL)) {
            ...
            RPC::call('lygneo_fill', 'bookmarkmucadderror', $html);
            RPC::commit();
    ...
    function ajaxBookmarkUrlAdd($form) 
    {
        if(!filter_var($form['url'], FILTER_VALIDATE_URL)) {
            ...
            RPC::call('lygneo_fill', 'bookmarkadderror', $html);
            RPC::commit();
        } elseif(trim($form['name']) == '') {
