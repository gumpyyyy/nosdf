 ...
 * handler.
 *
 * @author Lygneo Project <contact@lygneo.com>
 *
 ...
 * @mainpage
 *
 * Lygneo is an XMPP-based communication platform. It uses a widget-based UI
 * system. A widget is a combination of server-side and client-side scripts that
 * interact though a custom xmlrpc protocol.
 *
 * Lygneo's core is designed to ease the implementation of XMPP web-based clients,
