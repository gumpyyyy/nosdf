 ...
 *
 * @brief This class manage the Lygneo current Lygneo. It doesn't replace
...
class Sessionx {
    ...
    protected function __construct()
    {
        ...
        if(self::$_sessionid == null) {
            if(isset($_COOKIE['Lygneo_SESSION_ID'])) {
                self::$_sessionid = $_COOKIE['Lygneo_SESSION_ID'];
            } else {
                $this->regenerate();
            }
        }
    ...
    protected function regenerate()
    {
        ...
        setcookie('Lygneo_SESSION_ID', self::$_sessionid, time() + $this->_max_age);
    }
