...
class BaseController {
    ...
    function __construct() {
        ...
        $this->page->addScript('lygneo_hash.js');
        $this->page->addScript('lygneo_utils.js');
        $this->page->addScript('lygneo_base.js');
        $this->page->addScript('lygneo_tpl.js');
        $this->page->addScript('lygneo_rpc.js');
        $this->page->addScript('lygneo_lazy.js');
    }
