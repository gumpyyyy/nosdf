...
{
    $log = new Logger('lygneo');
    $log->pushHandler(new SyslogHandler('lygneo'));
    $log->addError($errstr);
    return false;
}
...
class Bootstrap {
    ...
    private function setContants() {
        define('APP_TITLE',     'Lygneo');
        define('APP_NAME',      'lygneo');
        ...
        define('LYGNEO_API',     'https://api.lygneo.com/');
    ...
    private function loadSystem() {
        ...
        require_once(SYSTEM_PATH . "LygneoException.php");
    ...
    private function loadModl() {
        ...
        if(file_exists(DOCUMENT_ROOT.'/config/db.inc.php')) {
            ...
            throw new LygneoException('Cannot find config/db.inc.php file');
        }
